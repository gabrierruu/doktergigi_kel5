...
(10, '04:01:00', '2025-10-01', 'Rabu', 5, 'Myobrace');
...
(1, 'Andi Pratama', '2015-03-12', 'Laki-Laki', 812345678, 'Jl. Merpati No.1'),
(2, 'Citra Lestari', '2013-11-05', 'Perempuan', 812345680, 'Jl. Melati No.3'),
(3, 'Fajar Nugroho', '2014-04-04', 'Laki-Laki', 812345683, 'Jl. Mawar No.6'),
(4, 'Indah Rahmawati', '2014-08-30', 'Perempuan', 812345686, 'Jl. Flamboyan No.9'),
(5, 'Syahroni', '2017-03-03', 'Laki-Laki', 812345686, 'Jalan Rumah Rangga 01'),
(8, 'Gaby', '2010-10-07', 'Perempuan', 812345683, 'Jalan Rumah Gaby01'),
(9, 'Dimas Bengbeng', '2016-07-05', 'Laki-Laki', 876545678, 'Jalan Rumah Rangga 02');
...
--
ALTER TABLE `appointment`
  MODIFY `id_appointment` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `kuota`
--
ALTER TABLE `kuota`
  MODIFY `id_kuota` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
